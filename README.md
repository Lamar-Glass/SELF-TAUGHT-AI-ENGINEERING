...
A comprehensive collection of **free and high-quality resources** to master AI, Machine Learning, Deep Learning, LLMs, Agents, MLOps, and more.
...
- [Statistics Fundamentals – Josh Starmer (StatQuest)](https://www.youtube.com/playlist?list=PLblh5JKOoLUK0FLuzwntyYI10UQFUhsY9)
...
- [Machine Learning – Josh Starmer](https://www.youtube.com/playlist?list=PLblh5JKOoLUICTaGLRoHQDuF_7q2GfuJF)
...
- [Mathematics for Deep Learning – D2L.ai](https://d2l.ai/chapter_appendix-mathematics-for-deep-learning/)
- [Deep Learning – Josh Starmer](https://www.youtube.com/playlist?list=PLblh5JKOoLUIxGDQs4LFFD--41Vzf-ME1)
...
- [Large Language Models Explained – YouTube](https://www.youtube.com/watch?v=LPZh9BOjkQs)
- [Intro to LLMs – YouTube](https://www.youtube.com/watch?v=zjkBMFhNj_g&pp=ygUDbGxt)
- [Understanding LLMs – Sebastian Raschka](https://magazine.sebastianraschka.com/p/understanding-large-language-models)
- [Visual Guide to Reasoning LLMs](https://newsletter.maartengrootendorst.com/p/a-visual-guide-to-reasoning-llms)
- [Understanding Reasoning & Multimodal LLMs – Raschka](https://magazine.sebastianraschka.com/)
- [Visual Guide to Mixture of Experts (MoE)](https://newsletter.maartengrootendorst.com/p/a-visual-guide-to-mixture-of-experts)
- [Finetuning LLMs – Raschka](https://magazine.sebastianraschka.com/p/finetuning-large-language-models)
...
## 💬 Prompt Engineering
- [Prompting Essentials – Google](https://www.coursera.org/google-learn/prompting-essentials)
...
- [Getting Structured Output – Deeplearning.ai](https://www.deeplearning.ai/short-courses/getting-structured-llm-output/)

---

## 🧠 Retrieval-Augmented Generation (RAG)
- [Intro to RAG – Coursera](https://www.coursera.org/projects/introduction-to-rag)
...
- [AI Agents – Chip Huyen](https://huyenchip.com/2025/01/07/agents.html)
...
- [MCP Guide – Anthropic](https://modelcontextprotocol.io/introduction)
- [MCP Course – Hugging Face](https://huggingface.co/learn/mcp-course/unit0/introduction)
- [Build Apps with MCP – Deeplearning.ai](https://www.deeplearning.ai/short-courses/mcp-build-rich-context-ai-apps-with-anthropic/)
- [Awesome MCP Servers – GitHub](https://github.com/punkpeye/awesome-mcp-servers)

---

## 🚀 MLOps & Deployment
- [Machine Learning in Production – Coursera](https://www.coursera.org/learn/introduction-to-machine-learning-in-production)
...
- [Build a LLM from Scratch – Manning](https://www.manning.com/books/build-a-large-language-model-from-scratch)
...
- [GPT: Language Understanding by Generative Pre-Training](https://cdn.openai.com/research-covers/language-unsupervised/language_understanding_paper.pdf)
- [GPT-3: Few-Shot Learners](https://arxiv.org/abs/2005.14165)
- [BERT: Bidirectional Transformers for Language Understanding](https://arxiv.org/abs/1810.04805)
